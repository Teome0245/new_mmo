...
// Mapping LBG v3 — voir LBG_IA_MMO/content/core3/core3_species_slot_map.json
const static char* Species[] = {
    "fel_rani", // human male (M)
    "plimp", // trandoshan male (L mesh, scale bas)
    "fae_lume", // twilek male (scale bas ; Mogrul = même mesh scale haut)
    "murrik", // bothan male (S)
    "kmiri", // zabrak male (M)
    "pykrel", // rodian male (XS)
    "mechari", // moncal male (M+)
    "varkoon", // wookiee male (XL)
    "tinkling", // sullustan male (S_M)
    "mogrul", // ithorian male (Mogrul scale bas)
    "fel_rani", // human female
    "plimp", // trandoshan female
    "fae_lume", // twilek female
    "murrik", // bothan female
    "kmiri", // zabrak female
    "pykrel", // rodian female
    "mechari", // moncal female
    "varkoon", // wookiee female
    "tinkling", // sullustan female
    "mogrul"  // ithorian female
};
