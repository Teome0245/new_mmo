  ...
  namespace managers {
   namespace director {
	...
	public:
		...
		static int spawnBuildingOnPlateau(lua_State* L);
		...
		static int getPlanetHeight(lua_State* L);
		static int addTerrainFlatten(lua_State* L);
		static int removeTerrainFlatten(lua_State* L);
		...
		static int pollIaBridgeCommand(lua_State* L);
		static int writeIaBridgePlayerSnapshot(lua_State* L);
		// IA Bridge: GameTime & WorldEventBus (MVP)
		static int iaConfigureGameTime(lua_State* L);
		static int iaGetGameTime(lua_State* L);
		static int iaGetDayPhase(lua_State* L);
		static int iaPublishWorldEvent(lua_State* L);
		static int iaPollWorldEvent(lua_State* L);
