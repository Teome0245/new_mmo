/*
 *	/home/sdesh/projects/new_mmo/lbg-mmo/server-core3/src/chat/PendingMessageList.cpp generated by engine3 IDL compiler 0.70
 */
...
Vector<unsigned long long>* PendingMessageListImplementation::getPendingMessages() {
	// chat/PendingMessageList.idl():   return pendingMessages;
	return (&pendingMessages);
}

void PendingMessageListImplementation::clearPendingMessages() {
	// chat/PendingMessageList.idl():   pendingMessages.removeAll();
	(&pendingMessages)->removeAll();
}

void PendingMessageListImplementation::addPendingMessage(unsigned long long oid) {
	// chat/PendingMessageList.idl():   pendingMessages.add(oid);
