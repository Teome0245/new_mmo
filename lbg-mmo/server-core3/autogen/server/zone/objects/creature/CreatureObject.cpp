...
String CreatureObjectImplementation::getSpeciesName() const{
	...
	// server/zone/objects/creature/CreatureObject.idl():  			return "";
	if (species == 0)	// server/zone/objects/creature/CreatureObject.idl():  			return "fel_rani";
	return "fel_rani";

	else 	// server/zone/objects/creature/CreatureObject.idl():  			return "";
	if (species == 1)	// server/zone/objects/creature/CreatureObject.idl():  			return "pykrel";
	return "pykrel";

	else 	// server/zone/objects/creature/CreatureObject.idl():  			return "";
	if (species == 2)	// server/zone/objects/creature/CreatureObject.idl():  			return "plimp";
	return "plimp";

	else 	// server/zone/objects/creature/CreatureObject.idl():  			return "";
	if (species == 3)	// server/zone/objects/creature/CreatureObject.idl():  			return "mechari";
	return "mechari";

	else 	// server/zone/objects/creature/CreatureObject.idl():  			return "";
	if (species == 4)	// server/zone/objects/creature/CreatureObject.idl():  			return "varkoon";
	return "varkoon";

	else 	// server/zone/objects/creature/CreatureObject.idl():  			return "";
	if (species == 5)	// server/zone/objects/creature/CreatureObject.idl():  			return "murrik";
	return "murrik";

	else 	// server/zone/objects/creature/CreatureObject.idl():  			return "";
	if (species == 6)	// server/zone/objects/creature/CreatureObject.idl():  			return "fae_lume";
	return "fae_lume";

	else 	// server/zone/objects/creature/CreatureObject.idl():  			return "";
	if (species == 7)	// server/zone/objects/creature/CreatureObject.idl():  			return "kmiri";
	return "kmiri";

	else 	// server/zone/objects/creature/CreatureObject.idl():  			return "";
	if (species == 0x21)	// server/zone/objects/creature/CreatureObject.idl():  			return "mogrul";
	return "mogrul";

	else 	// server/zone/objects/creature/CreatureObject.idl():  			return "";
	if (species == 0x31)	// server/zone/objects/creature/CreatureObject.idl():  			return "tinkling";
	return "tinkling";
