...
ELSE (WIN32)
  # Debian/Ubuntu multiarch + MariaDB client (libmariadb-dev) uses libmariadb, not libmysqlclient
  FIND_LIBRARY(MYSQL_LIB NAMES mysqlclient mariadb mariadbclient
          PATHS
...
IF (MYSQL_INCLUDE_DIR AND MYSQL_LIB_DIR)
  ...
  GET_FILENAME_COMPONENT(_mysql_lib_we ${MYSQL_LIB} NAME_WE)
  STRING(REGEX REPLACE "^lib" "" MYSQL_CLIENT_LIBS "${_mysql_lib_we}")
